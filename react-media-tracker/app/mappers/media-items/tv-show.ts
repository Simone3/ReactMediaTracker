...
import { IdentifiedTvShow, TvShowFilter, TvShowSortBy, TvShowSortField } from 'app/models/api/media-items/tv-show';
import { TvShowFilterInternal, TvShowInternal, TvShowSortByInternal, TvShowSortFieldInternal } from 'app/models/internal/entities/media-items/tv-show';
