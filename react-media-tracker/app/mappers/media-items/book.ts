...
import { BookFilter, BookSortBy, BookSortField, IdentifiedBook } from 'app/models/api/media-items/book';
import { BookFilterInternal, BookInternal, BookSortByInternal, BookSortFieldInternal } from 'app/models/internal/entities/media-items/book';
